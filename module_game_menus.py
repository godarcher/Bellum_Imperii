...
game_menus = [
  ("start_game_0",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    "Welcome, adventurer, to Bellum Imperii. ",
    "none",
    [],
	[
...
^Where would you like to begin your adventure?",
    ...
    [  ("town_23",[(eq, "$current_startup_quest_phase", 0),
                 ],"Eblana, Ireland",
       [
...
#		 (jump_to_menu, "mnu_start_phase_2_5"),
      ...
      ("town_9",[(eq, "$current_startup_quest_phase", 0),
                 ],"Byzantium, Eastern Greece",
       [
         (assign, "$current_town", "p_town_8_2"),
         (assign, "$g_starting_town", "$current_town"),
	...
	#	 (jump_to_menu, "mnu_start_phase_2_5"),
      ...
      ("town_1",[(eq, "$current_startup_quest_phase", 0),       
                 ],"Rome, the economical and cultural center of the Roman Empire",
       [
...
#		 (jump_to_menu, "mnu_start_phase_2_5"),
      ...
      ("town_40",[(eq, "$current_startup_quest_phase", 0),   #Irish
                 ],"Arus, Northern Germania.",
       [
...
#		 (jump_to_menu, "mnu_start_phase_2_5"),
      ...
      ("town_18",[(eq, "$current_startup_quest_phase", 0),   #Irish
                 ],"Ctesiphon, Capital of the Parthian Kingdom.",
       [
...
#		 (jump_to_menu, "mnu_start_phase_2_5"),
      ...
      ("town_7",[(eq, "$current_startup_quest_phase", 0),
                 ],"Alexandria, Egypt",
       [
         (assign, "$current_town", "p_town_9_2"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_jelkala"),
#		 (jump_to_menu, "mnu_start_phase_2_5"),
         (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
      ...
      ("town_26",[(eq, "$current_startup_quest_phase", 0),
                 ],"Neapolis Scythica, Capital of the Sarmatians",
       [
...
#This needs to be the first window!!! dunde
  (
    ...
    "Welcome, adventurer, to Bellum Imperii. Before you can start playing the game you must create a character.",
    "none",
    [(try_begin),
...
##    (else_try),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_germanshirt3",0),
        (troop_add_item, "trp_player","itm_leather_boots",imod_ragged),
        (troop_add_item, "trp_player","itm_fur_hat",0),
...
## JART  
	("ad_dplmc_camp_preferences",
		[
		],
		"Advanced Diplomacy preferences.",
		[
  ...
  ("camp_cheat",0,
   ...
   [
    ...
    [
	  ...
	  ("cheat_faction_orders99",[],"{!}Cheat: add Spartacus",
       [(party_add_members, "p_main_party", "trp_spartacus", 1),
         (jump_to_menu, "mnu_camp_cheat"),
        ]
       ),
	  ("cheat_faction_orders2",[],"{!}Cheat: add 24 preatorian roman troops and 1 roman centurion to the party",
       [(party_add_members, "p_main_party", "trp_roman_gaul_exp_prae", 24),
	   (party_add_members, "p_main_party", "trp_roman_prae_primus_pilus", 1),
         (jump_to_menu, "mnu_camp_cheat"),
        ]
       ),
	 ("cheat_faction_orders3",[],"{!}Cheat: add 25 spartans to your party",
       [(party_add_members, "p_main_party", "trp_spartan", 25),
         (jump_to_menu, "mnu_camp_cheat"),
        ]
       ),
	 ("cheat_faction_orders4",[],"{!}Cheat: add 25 Sacred Band troops to your party",
       [(party_add_members, "p_main_party", "trp_sacred_band", 24),
	    (party_add_members, "p_main_party", "trp_sacred_leader", 1),
         (jump_to_menu, "mnu_camp_cheat"),
        ]
       ),
          ...
          (else_try),            
            (try_begin), #my kingdom
              ...
              (else_try), #player took a walled center for player's kingdom
                ...
                (assign, ":best_troop", "trp_roman_n_aux_vet_archer"),
  ...
  (
    ...
    [
        ...
        (try_begin),
		  ...
		  (val_min, ":str_id", 4),
		  (try_begin),
			(is_between, "$current_town", "p_village_1_1", villages_end),
...
#		(try_end),
      ...
      "Take a walk around the streets.",
       [
         ...
         (else_try),
           ...
           (else_try),
             (assign,reg0,"trp_roman_n_legionary"),
             (assign,reg1,"trp_roman_n_legionary"),
             (assign,reg2,"trp_roman_n_legionary"),
             (assign,reg3,"trp_roman_n_legionary"),
           (try_end),
           (shuffle_range,0,4),
 ...
 ("enter_senate",[(eq, "$g_encountered_party", "p_town_1_1"),],"Visit the Senate floor.",[
        (modify_visitors_at_site,"scn_senate"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		(set_visitor, 2, "trp_senator_1"),
		(set_visitor, 3, "trp_senator_2"),
		(set_visitor, 23, "trp_roman_n_armoured_legionary"),
		(set_visitor, 38, "trp_roman_n_armoured_legionary"),
		(set_visitor, 4, "trp_senators"),
		(set_visitor, 5, "trp_senators"),
		(set_visitor, 6, "trp_senators"),
		(set_visitor, 7, "trp_senators"),
		(set_visitor, 8, "trp_senators"),
		(set_visitor, 9, "trp_senators"),
		(set_visitor, 9, "trp_senators"),
		(set_visitor, 10, "trp_senators"),
		(set_visitor, 11, "trp_senators"),
		(set_visitor, 12, "trp_senators"),
		(set_visitor, 13, "trp_senators"),
		(set_visitor, 14, "trp_senators"),
		(set_visitor, 15, "trp_senators"),
		(set_visitor, 16, "trp_senators"),
		(set_visitor, 17, "trp_senators"),
		(set_visitor, 18, "trp_senators"),
		(set_visitor, 19, "trp_senators"),
		(set_visitor, 20, "trp_senators"),
		(set_visitor, 21, "trp_senators"),
		(set_visitor, 22, "trp_senators"),
		(set_visitor, 24, "trp_senators"),
		(set_visitor, 25, "trp_senators"),
 ...
 ("enter_temple_athenae",[(eq, "$g_encountered_party", "p_town_8_1"),],"Visit the Temple.",[
		(modify_visitors_at_site,"scn_roman_temple"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		(set_visitor, 2, "trp_roman_n_armoured_legionary"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_temple"),
		(change_screen_mission),		
	]),		
	
 ("enter_port_alexandria",[(eq, "$g_encountered_party", "p_town_9_2"),],"Visit the Port.",[
		(modify_visitors_at_site,"scn_alexandria_port"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		(set_visitor, 2, "trp_roman_n_armoured_legionary"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_alexandria_port"),
		(change_screen_mission),		
	]),		
      ...
      ("tournament_join_next_fight", [], "Fight in the next round.",
       [
           ...
           (try_begin),
             ...
             (try_begin),
               (eq, ":mod", 0),
               (call_script, "script_set_items_for_tournament", 40, 80, 50, 20, 0, 0, 0, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (else_try),
               (eq, ":mod", 1),
               (call_script, "script_set_items_for_tournament", 100, 100, 0, 0, 0, 0, 0, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (else_try),
               (eq, ":mod", 2),
               (call_script, "script_set_items_for_tournament", 100, 0, 100, 0, 0, 0, 0, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (else_try),
               (eq, ":mod", 3),
               (call_script, "script_set_items_for_tournament", 40, 80, 50, 20, 40, 0, 0, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (try_end),
           (else_try),
             ...
             (else_try),
               (eq, ":mod", 1),
               (call_script, "script_set_items_for_tournament", 100, 50, 0, 0, 0, 20, 30, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (else_try),
               (eq, ":mod", 2),
               (call_script, "script_set_items_for_tournament", 100, 0, 50, 0, 0, 20, 30, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (else_try),
               (eq, ":mod", 3),
               (call_script, "script_set_items_for_tournament", 40, 80, 50, 20, 30, 0, 60, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (try_end),
           (else_try),
             ...
             (try_begin),
               (eq, ":mod", 0),
               (call_script, "script_set_items_for_tournament", 100, 0, 0, 0, 0, 40, 60, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (else_try),
               (eq, ":mod", 1),
               (call_script, "script_set_items_for_tournament", 100, 50, 25, 0, 0, 30, 50, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (try_end),
           (else_try),
             ...
             (try_begin),
               (eq, ":mod", 0),
               (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 0, 0, 0, 0, "itm_ad_roman_tunic_pectoral_01", -1),
             (else_try),
               (eq, ":mod", 1),
               (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 50, 0, 0, 0, "itm_ad_roman_tunic_pectoral_01", -1),
             (else_try),
               (eq, ":mod", 2),
               (call_script, "script_set_items_for_tournament", 40, 0, 0, 100, 0, 0, 0, 0, "itm_ad_roman_tunic_pectoral_01", -1),
             (try_end),
           (else_try),
             #Rhodoks
             (eq, ":town_original_faction", "fac_kingdom_5"),
             (call_script, "script_set_items_for_tournament", 25, 100, 60, 0, 30, 0, 30, 50, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
           (else_try),
             #Sarranids
             (store_mod, ":mod", ":town_index_within_faction", 2),
             (try_begin),
               (eq, ":mod", 0),
               (call_script, "script_set_items_for_tournament", 100, 40, 60, 0, 30, 30, 0, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (else_try),
               (call_script, "script_set_items_for_tournament", 50, 0, 60, 0, 30, 30, 0, 0, "itm_ad_roman_tunic_pectoral_01", "itm_murmillo_helmet"),
             (try_end),
           (try_end),
           (jump_to_scene, ":arena_scene"),
           (change_screen_mission),
...
#		(str_store_faction_name, s9, "$players_kingdom"),
  ...
  (
    ...
    "The world Conquered by One Kingdom^^{s1} has defeated all rivals and stands as the sole kingdom.",
    "none",
    [
      (str_store_faction_name, s1, "$g_notification_menu_var1"),
      (set_fixed_point_multiplier, 100),
	  ...
	  [
	    ...
	    (else_try),
	      ...
	      (else_try),			
	        ...
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	    		
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_8"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_9"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_10"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_11"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_12"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_13"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_14"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_15"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_16"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_17"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_18"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_19"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_22"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 	
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_23"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 	
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_26"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 	
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_27"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 	
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_28"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 	
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_29"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 	
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_30"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 	
	      (else_try),			
	        (eq, ":starting_town_faction", "fac_kingdom_31"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	 				
	      (try_end),  
	    (try_end),
...
#menu_aud_with_commander 
  (
    ...
    #menu_revolt
    ("revolt",0,
    "Do you want to release the slaves to help your men?",
    "none",
    [
		(assign, "$cant_leave_encounter", 1),
    ...
    [
        ...
        ("revolt_no_prisoners",[],"No, I don't trust slaves.",
        [
			(start_encounter, "$enlisted_party"),
            (change_screen_map),
        ]),
...
# Merc Camp Begin   
  (
    ...
    [],
    [
      ("enter_camp_legion_1_camp",[(eq, "$g_encountered_party", "p_camp_legion_1"),],"Visit the XIII Gemina Legion Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		(set_visitor, 2, "trp_heras"),
		(set_visitor, 5, "trp_i_gemina_legionary"),
		(set_visitor, 6, "trp_i_gemina_legionary"),
		(set_visitor, 7, "trp_i_gemina_legionary"),
		(set_visitor, 8, "trp_i_gemina_legionary"),
		(set_visitor, 9, "trp_i_gemina_legionary"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	
      ("enter_camp_legion_2_camp",[(eq, "$g_encountered_party", "p_camp_legion_2"),],"Visit the II Adiutrix Legion Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_ii_adiutrix_legionary"),
		(set_visitor, 6, "trp_ii_adiutrix_legionary"),
		(set_visitor, 7, "trp_ii_adiutrix_legionary"),
		(set_visitor, 8, "trp_ii_adiutrix_legionary"),
		(set_visitor, 9, "trp_ii_adiutrix_legionary"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	
     ("enter_camp_legion_3_camp",[(eq, "$g_encountered_party", "p_camp_legion_3"),],"Visit the VI Victrix Legion Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_vi_victrix_legionary"),
		(set_visitor, 6, "trp_vi_victrix_legionary"),
		(set_visitor, 7, "trp_vi_victrix_legionary"),
		(set_visitor, 8, "trp_vi_victrix_legionary"),
		(set_visitor, 9, "trp_vi_victrix_legionary"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	
     ("enter_camp_legion_4_camp",[(eq, "$g_encountered_party", "p_camp_legion_4"),],"Visit the I Parthia Legion Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_i_parthia_legionary"),
		(set_visitor, 6, "trp_i_parthia_legionary"),
		(set_visitor, 7, "trp_i_parthia_legionary"),
		(set_visitor, 8, "trp_i_parthia_legionary"),
		(set_visitor, 9, "trp_i_parthia_legionary"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	
     ("enter_camp_legion_5_camp",[(eq, "$g_encountered_party", "p_camp_legion_5"),],"Visit the IX Hispana Legion Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_ix_hispana_legionary"),
		(set_visitor, 6, "trp_ix_hispana_legionary"),
		(set_visitor, 7, "trp_ix_hispana_legionary"),
		(set_visitor, 8, "trp_ix_hispana_legionary"),
		(set_visitor, 9, "trp_ix_hispana_legionary"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	
     ("enter_camp_legion_6_camp",[(eq, "$g_encountered_party", "p_camp_legion_6"),],"Visit the XXII Primigenia Legion Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_xxii_primigenia_legionary"),
		(set_visitor, 6, "trp_xxii_primigenia_legionary"),
		(set_visitor, 7, "trp_xxii_primigenia_legionary"),
		(set_visitor, 8, "trp_xxii_primigenia_legionary"),
		(set_visitor, 9, "trp_xxii_primigenia_legionary"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	
       ("enter_greek_merc_camp",[(eq, "$g_encountered_party", "p_camp_greeks"),],"Enter the Greek mercenary camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_greek_mercenary"),
		(set_visitor, 6, "trp_greek_mercenary"),
		(set_visitor, 7, "trp_greek_mercenary"),
		(set_visitor, 8, "trp_greek_mercenary"),
		(set_visitor, 9, "trp_greek_mercenary"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	
      ("enter_nubian_merc_camp",[(eq, "$g_encountered_party", "p_camp_nubians"),],"Enter the Nubian Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_nubian_spearman"),
		(set_visitor, 6, "trp_nubian_spearman"),
		(set_visitor, 7, "trp_nubian_spearman"),
		(set_visitor, 8, "trp_nubian_spearman"),
		(set_visitor, 9, "trp_nubian_spearman"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	
	
      ("enter_nubian_merc_camp",[(eq, "$g_encountered_party", "p_camp_egyptian"),],"Enter the Egyptian Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_egyptian_footman"),
		(set_visitor, 6, "trp_egyptian_footman"),
		(set_visitor, 7, "trp_egyptian_footman"),
		(set_visitor, 8, "trp_egyptian_footman"),
		(set_visitor, 9, "trp_egyptian_footman"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	

      ("enter_nubian_merc_camp",[(eq, "$g_encountered_party", "p_camp_illyrian"),],"Enter the Illyrian Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_illyrian_footman"),
		(set_visitor, 6, "trp_illyrian_footman"),
		(set_visitor, 7, "trp_illyrian_footman"),
		(set_visitor, 8, "trp_illyrian_footman"),
		(set_visitor, 9, "trp_illyrian_footman"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	

      ("enter_nubian_merc_camp",[(eq, "$g_encountered_party", "p_camp_kushan"),],"Enter the Kushan Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_kushan_horseman"),
		(set_visitor, 6, "trp_kushan_horseman"),
		(set_visitor, 7, "trp_kushan_horseman"),
		(set_visitor, 8, "trp_kushan_horseman"),
		(set_visitor, 9, "trp_kushan_horseman"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	

      ("enter_nubian_merc_camp",[(eq, "$g_encountered_party", "p_camp_iberian"),],"Enter the Iberian Camp.",[
		(modify_visitors_at_site,"scn_roman_camp_1"),
		(reset_visitors),    
		(assign, "$g_mt_mode", tcm_default),   		
		(set_jump_entry, 1),
		...
		(set_visitor, 5, "trp_iberian_horseman"),
		(set_visitor, 6, "trp_iberian_horseman"),
		(set_visitor, 7, "trp_iberian_horseman"),
		(set_visitor, 8, "trp_iberian_horseman"),
		(set_visitor, 9, "trp_iberian_horseman"),
		(set_jump_mission,"mt_visit_town_castle"),
		(jump_to_scene,"scn_roman_camp_1"),
		(change_screen_mission),		
	]),	
