...
#chief
  ...
  ("banner_kingdom_3a", 0, "banner_kingdom_3a", "0", []),
...
##    ]),     
  ...
  ("belfry_a",sokf_moveable|sokf_destructible|spr_hit_points(15000),"belfry_a","bo_belfry_a",[]),
  ...
  ("belfry_platform_a",sokf_moveable|sokf_destructible|spr_hit_points(15000),"belfry_platform_a","bo_belfry_platform_a",[]),
   ("belfry_platform_b",sokf_moveable|sokf_destructible|spr_hit_points(15000),"belfry_platform_b","bo_belfry_platform_b", []),
...
####chief acaba
  ...
  ("temple_a",0,"temple_a","bo_temple_a", []),
  ("temple_tower_a",0,"temple_tower_a","bo_temple_tower_a", []),
...
###chief cambiado mantlets mantelete siege warfare
 ...
 #For Rome siege mechanisms starting
  
  #part 1 For Rome ballista 
   ("ballista_pickup_rock",sokf_moveable|spr_use_time(1),"rock_ammo","bo_rock_ammo", [
    (ti_on_scene_prop_use,
    [
	  (scene_prop_get_instance, ":ammorock", "spr_ballista_pickup_rock", 0),
      (prop_instance_get_position, pos1, ":ammorock"),
	  (position_move_y, pos1, -10000), #100 meter down to asure its underground
	  (get_player_agent_no, ":player_agent"),
	  #(assign, "$g_player_carries_stone", 1),
	  (agent_equip_item, ":player_agent", "itm_rock_ammo"),
	  (agent_set_wielded_item, ":player_agent", "itm_rock_ammo"),
    ]),
  ]),
  
  ("ballista_loaded",sokf_moveable|spr_use_time(1),"ballistarome","bo_ballistarome", [
    (ti_on_scene_prop_use,
    [
	  (try_begin),
	    (eq, "$g_reload", 0),
		...
		(scene_prop_get_instance, ":ballista", "spr_ballista_loaded", 0),
		(prop_instance_get_position, pos3, ":ballista"),
		(get_distance_between_positions_in_meters, ":distance", pos1, pos3),
		(this_or_next|neq, "$g_to_shoot", 1),
		(neq, "$g_to_shoot", 2),
		(try_begin),
			(le, ":distance", 3),
			(mission_cam_clear_target_agent),
			(mission_cam_set_mode,1),  
			#(position_move_x, pos3, 11), #0.11 #not move at all!
			(position_move_z, pos3, 100), #move up
			(position_move_y, pos3, 40),
			(position_rotate_z, pos3, 180),
			(mission_cam_animate_to_position, pos3, 1, 0),
			(assign, "$g_to_shoot", 1),
			(display_message, "@using ballista"),
		(else_try),
			(gt, ":distance", 3),
			(display_message, "@player distance to far"),
		(try_end),
	(else_try),
		(eq, "$g_reload", 1), #then the use is reloading
		(get_player_agent_no, ":player_agent"), # get player agent
		(agent_get_wielded_item, ":rock?", ":player_agent", 0),
		(eq, ":rock?", "itm_rock_ammo"), #if player is carrying rock
		(scene_prop_get_instance, ":ballista", "spr_ballista_loaded", 0),
		(prop_instance_get_position, pos3, ":ballista"),
		(position_move_z, pos3, 233), 
		(agent_set_scripted_destination, ":player_agent", pos3, 1, 1), #so animation played works perfectly
		#agent_play_animation lay down rock 
		(agent_unequip_item, ":player_agent", ":rock?"),
  ...
  ("scorpio_loaded",sokf_moveable|spr_use_time(1),"ballistarome","bo_ballistarome", [
    (ti_on_scene_prop_use,
    [
	  (try_begin),
	    (eq, "$g_reload", 0),
		(get_player_agent_no, ":player_agent"), # get player agent
		(agent_get_position, pos1, ":player_agent"),
		(scene_prop_get_instance, ":ballista", "spr_scorpio_loaded", 0),
		(prop_instance_get_position, pos3, ":ballista"),
		(get_distance_between_positions_in_meters, ":distance", pos1, pos3),
		(this_or_next|neq, "$g_to_shoot", 1),
		(neq, "$g_to_shoot", 2),
  ...
  ("carroballista_loaded",sokf_moveable|spr_use_time(1),"carroballista","bo_carroballista", [
    (ti_on_scene_prop_use,
    [
	  (try_begin),
	    (eq, "$g_reload", 0),
		(get_player_agent_no, ":player_agent"), # get player agent
		(agent_get_position, pos1, ":player_agent"),
		(scene_prop_get_instance, ":ballista", "spr_carroballista_loaded", 0),
		(prop_instance_get_position, pos3, ":ballista"),
		(get_distance_between_positions_in_meters, ":distance", pos1, pos3),
		(this_or_next|neq, "$g_to_shoot", 1),
		(neq, "$g_to_shoot", 2),
		(try_begin),
			...
			(mission_cam_animate_to_position, pos3, 1, 0),
			(assign, "$g_to_shoot", 1),
			(display_message, "@using carroballista"),
		(else_try),
			(gt, ":distance", 3),
			(display_message, "@player distance to far"),
		(try_end),
  ...
  ("ballista_loaded_bow",0,"ballista_loaded_bow","bo_ballista_loaded_bow",  []),
  ("ballista_unloaded_bow",sokf_moveable|spr_use_time(10),"ballista_unloaded_bow","bo_ballista_unloaded_bow", [
    (ti_on_scene_prop_use,
    [
	  (scene_prop_get_instance, ":ballistabow", "spr_ballista_unloaded_bow", 0),
	  (replace_prop_instance, ":ballistabow", "spr_ballista_loaded_bow"),
	  (assign, "$g_reload", 0),
    ]),
  ]),
  
  ("ballista_unloaded",0,"ballista_unloaded","bo_ballista_unloaded", []),
  ("ballista_ammo_missile",0,"ballista_ammo","0", []),
  ("ballista_ammo_rock",0,"rock_ammo","0", []),
   
# For Rome Ballista end

# gladiators begin # for rome
  ("netshield",0,"net_scutum","bo_net_scutum", []),
  ("netshield_2",0,"net_scutum","bo_net_scutum", []),
  ("desert_wall",0,"desert_wall","bo_desert_wall", []),
# gladiators end 

# for rome boiling oil begin
  ("boiling_oil",spr_use_time(2),"cauldron_a","bo_cauldron_a", [
     (ti_on_scene_prop_use,
      [
        (store_trigger_param_1, ":user"),
		(scene_prop_get_instance, ":boiling_oil", "spr_boiling_oil", 0),
		(prop_instance_get_position, pos3, ":boiling_oil"), #we have boiling oil position
		(scene_prop_get_instance, ":boiling_oil_point", "spr_boiling_oil_point", 0),
		(prop_instance_get_position, pos2, ":boiling_oil_point"),
		(position_rotate_x, pos3, 180), #rotation fixed
		(prop_instance_rotate_to_position, ":boiling_oil", pos3, 10),
		(particle_system_burst, "psys_torch_fire", pos3, 30), #set fire at damage point
		(particle_system_burst, "psys_torch_fire", pos2, 30), #set fire at damage point
		(particle_system_burst, "psys_torch_fire", pos3, 30), #set fire at damage point
		(particle_system_burst, "psys_torch_fire", pos2, 30), #set fire at damage point
		(try_for_agents,":agent"), # search all agents   
	        (agent_is_alive,":agent"), # exclude dead agents
		    (agent_is_human,":agent"), #horses are not in sieges so why change?
			(agent_get_position, pos1, ":agent"),
			(get_distance_between_positions, ":dist", pos1, pos2),
			(le, ":dist", 500),
			(agent_deliver_damage_to_agent, ":user", ":agent", 1000),
			(display_message, "@damage working"),
		(try_end),
        ]),
     ]),
  ("boiling_oil_done",0,"cauldron_a2", "bo_cauldron_a2", []),
  ("boiling_oil_point",0,"cauldron_a223", "bo_cauldron_a233", []),
# for rome boiling oil end

("physics_head" ,sokf_dynamic_physics,"bloodystumps" ,"bloodystumps_bo" , []),
	( "head2",0,"head","bo_head",[]),
  ...
  ("hand", sokf_moveable|sokf_dynamic_physics,"chopped_hand_ground","bo_chopped_hand_ground",
  [
    (ti_on_init_scene_prop,
     [
        (store_trigger_param_1, ":hand_id"),

        (set_fixed_point_multiplier, 100),
        (position_set_x, pos11, 500), #mass = 5.00 kg
        (position_set_y, pos11, 90), #friction coefficient = 0.90 (skin 0.80 - 1.00)
        (position_set_z, pos11, 0), #reserved
        (prop_instance_dynamics_set_properties, ":hand_id", pos11),

        (position_set_x, pos11, 500),
        (position_set_y, pos11, 250),
        (position_set_z, pos11, 100),
        (prop_instance_dynamics_set_omega, ":hand_id", pos11), #spin

        (position_set_x, pos11, 100),
        (position_set_y, pos11, 300),
        (position_set_z, pos11, -400),
        (prop_instance_dynamics_apply_impulse, ":hand_id", pos11), #force
     ]),
  ]),
  
    ("leg", sokf_moveable|sokf_dynamic_physics,"chopleg","bo_chopleg",
  [
    (ti_on_init_scene_prop,
     [
        (store_trigger_param_1, ":hand_id"),
...
#################################################
   ("ship_a",sokf_moveable,"longship","bo_longship", []),
 ("ships_end",0,0,0,[]),
...
# from 'OSP_new_rome_3.brf': begin (OpenBRF)
...
# from 'OSP_new_rome_3.brf': end (OpenBRF)

# from 'BI_Eastern_Props.brf': begin (OpenBRF)
	...
	( "scythian_fence"                             ,0,"scythian_fence","bo_scythian_fence",[]),
	( "scythian_fence_b"                           ,0,"scythian_fence_b","bo_scythian_fence_b",[]),
	( "scythian_hut_1"                             ,0,"scythian_hut_1","bo_scythian_hut_1",[]),
	( "scythian_hut_1b"                            ,0,"scythian_hut_1b","0",[]),
	( "scythian_hut_2"                             ,0,"scythian_hut_2","bo_scythian_hut_2",[]),
	( "scythian_hut_2b"                            ,0,"scythian_hut_2b","0",[]),
	( "scythian_hut_2c"                            ,0,"scythian_hut_2c","0",[]),
	( "scythian_hut_3"                             ,0,"scythian_hut_3","bo_scythian_hut_3",[]),
	( "scythian_hut_3b"                            ,0,"scythian_hut_3b","0",[]),
	( "scythian_wall"                              ,0,"scythian_wall","bo_scythian_wall",[]),
...
# from 'BI_Eastern_Props.brf': end (OpenBRF)

# from 'BI_Roman_Buildings.brf': begin (OpenBRF)
	( "roman_farm_house_1"                         ,0,"roman_farm_house_1","bo_roman_farm_house_1",[]),
	( "roman_farm_house_2"                         ,0,"roman_farm_house_2","bo_roman_farm_house_2",[]),
# from 'BI_Roman_Buildings.brf': end (OpenBRF)
