...
("relic", "Find the lost Eagle", qf_random_quest,
  "The Senator has asked me to retrieve the lost Eagle, it seems to be stolen bij a band of thiefs which are operating around Patavium. The key objective is to capture their leader in order to retrieve the Eagle! "
  ),
