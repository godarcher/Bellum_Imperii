...
##  ("nothing", "nothing"),
  ...
  ("tutorial_map1","Welcome to Bellum Imperii 1.5!"),
...
# Retirement Texts: s7=village name; s8=castle name; s9=town name
 ...
 and you sit a throne in your own splendourous palace as one of the most powerful figures in the world."),
...
#backstory main body
  ...
  ("npc5_backstory_b", "For as long as any one can remember, our people have feuded with the tribe of Humyan, many of whom have settled in the next valley over. Many men have died in this feud, on both sides, including two of my brothers. The Khan himself has ordered us to cease, to save men for the wars in the world. But I know my rights, and my brothers' blood cries out for vengeance. I waylaid and killed a Humyan on a track over the mountains, and I rode out of our village the same night, without even having had the chance to bid farewell to my father. I will bide my time, for a year or two, then return home when the Khan's men have forgotten. The Humyan will not forget, of course, but such is the price of honour."),
...
#backstory recruit pitch
  ...
  ("npc7_backstory_c", "But I do not count myself unlucky, stranger, no more than any other woman, this fetid backwater, this dungheap among the nations, populated by apes and jackals."),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc6_backstory_later", "I have been wandering the world, but have yet to find redemption."),
...
### set off by behavior after victorious battle
  ...
  ("npc6_personalitymatch_speech", "Captain. Sometimes I am troubled by all this bloodshed, although I know that proud warlords must be humbled, and cruel bandits tamed, if we are to restore peace to the world."),
  ...
  ("npc10_retirement_speech", "I've had enough of tromping up and down the length and breadt of Europe. I've got enough to buy a small bit of land somewhere, so I think I'll give that a try. So long, and best of luck to you."),
...
#multiplayer game type names
  ...
  ("trade_explanation_palms", "I tend to a grove of date palms. We grow them using well-water, and export the fruit far and wide, as they keep for many months when properly dried. As sweet as honey, and they grant the eater health and vigor."),
...
#STRINGS ADDED AFTER THE FREEZE
 ...
 ("journey_to_reyvadin", "You have come through the highlands, a plateau exposed to the bitter winds from the north. The land here is frozen for most of the year, but the forests are rich with fur-bearing game, and the rivers are teaming with fish. The riches of the land draw the traders, but the traders in turn draw bandits. You saw the occasional dark figure mounted on a shaggy pony, watching the passage of your caravan from a snowy ridge, and were glad when the spires of Eblana came into view across the wide valley."),

 ("journey_to_praven", "You came by caravan through the heartland of Europe. Green shoots of wheat, barley and oats are beginning to push through the dark soil of the rolling hills, and on the lower slopes of the snowcapped mountains, herds of cattle and sheep are grazing on the spring grass. Occasionally, too, you catch sight of one of the great warhorses that are the pride of the Parthian nobility. The land here is rich -- but also troubled, as the occasional burnt-out farm bears witness. You keep a wide berth of the forests, where desperate men have taken refuge, and it is some relief when you crest a ridge and catch sight of the great city of Ctesiphon, its rooftops made golden by the last rays of the setting sun."),

  ("journey_to_jelkala", "You came by ship, skirting the cliffs where the ands meet the sea. Much of the coastline was obscured by tendrils of fog that snaked down the river valleys, but occasionally you caught sight of a watchtower rising above the mists -- and on one occasion, a beacon fire burning to warn of an enemy warband. You knew that you were relatively safe at sea, as you were too far south to risk encountering the sea raiders who trouble the coasts of the nordic coastlands, but it was still a relief to reach the mainland, in the distance you see the town of Arus, home of the Cimbri tribe."),

  ("journey_to_sargoth", "You took passage with a trading ship, carrying gyrfalcons from the furthest reaches of the north to be bartered for linen and wool. It sailed early in the season, but the master reckoned that the risks of storms could be justified by arriving ahead of the pirates, who by April would be sailing forth from their island lairs to ravage Europe's coasts. It was some relief when your ship came in sight of the harbours of Rome."),

  ("journey_to_tulga", "You came with a caravan, crossing the mountains that border Greece on the north and east, bringing spices from faraway lands to trade for wool and salt. The passes were still choked with snow, and it was hard going, but at last you crested a ridge and saw before you greek countryside. In the distance you see Byzantium, a strategicly positioned city and the gateway between Europe and Asia.."),
...
## Player Background
  ...
  ("swadian","Roman"),
  ("swadian2","Roman (tall)"),
  ("swadian3","Roman (short)"),
  ("saxon","Dacian"),
  ("saxon2","Dacian (tall)"),
  ("saxon3","Dacian (short)"),
  ("jute","Parthian"),
  ("jute2","Parthian (tall)"),
  ("jute3","Parthian (short)"),
  ("kushan","Kushan"),
  ("kushan2","Kushan (tall)"),
  ("kushan3","Kushan (short)"),  
  ("dahae","Dahaen"),
  ("dahae2","Dahaen (tall)"),
  ("dahae3","Dahaen (short)"),    
  ("frisian","Numidian"),
  ("frisian2","Numidian (tall)"),
  ("frisian3","Numidian (short)"),
  ("egyptian","Egyptian"),
  ("egyptian2","Egyptian (tall)"),
  ("egyptian3","Egyptian (short)"),  
  ("greek","Greek"),
  ("greek2","Greek (tall)"),
  ("greek3","Greek (short)"),    
  ("vaegir","German"),
  ("vaegir2","German (tall)"),
  ("vaegir3","German (short)"),
  ("khergit","Briton"),
  ...
  ("nord3","Slavic (short)"),
  ("armenian","Armenian"),
  ("armenian2","Armenian (tall)"),
  ("armenian3","Armenian (short)"),  
  ("rhodok","Sarmatian"),
  ("rhodok2","Sarmatian (tall)"),
  ("rhodok3","Sarmatian (short)"),
  ("parent_noble","Noble"),
  ("parent_merchant","Merchant"),
  ("parent_guard","Veteran Soldier"),
  ("parent_forester","Outlaw"),
  ("parent_nomad","Free Peasant (Serf)"),
  ("parent_thief","Slave"),
  ("parent_priest","Priest"),
  ("childhood_page","Brought Up In a Senator Court"),
  ...
  ("job_bravo","{reg11?Senator's Wife:Senator}"),
  ("job_merc","Slave"),
  ("job_noble","{reg11?A lady-in-waiting:Legionaire}"),
  ("job_troubadour","Bard"),
  ("job_student","{reg11?Peasant's Wife:Free Peasant}"),
  ("job_peddler","Merchant"),
  ("job_craftsman","Blacksmith"),
  ("job_poacher","Poacher"),
  ("job_preacher","Roman Legatus (See Descr)"),
...
## The Legend Continues
  ("story_swadian","You are an Roman and you are of an average height. A civilian of the Roman Empire.^^"),
  ("story_swadian2","You are an Roman and you are tall and strong. A civilian of the Roman Empire^^"),
  ("story_swadian3","You are an Roman and you are short in stature but agile. A civilian of the Roman Empire^^"),
  ("story_saxon","You are a Dacian and you are of an average height. A member of a Dacian tribe.^^"),
  ("story_saxon2","You are a Dacian and you are tall and strong.  A member of a Dacian tribe^^"),
  ("story_saxon3","You are a Dacian and you are short in stature but agile. A member of a Dacian tribe.^^"),
  ("story_jute","You are a Parthian and you are of an average height. A loyal servant of the Parthian King.^^"),
  ("story_jute2","You are a Parthian and you are tall and strong. A loyal servant of the Parthian King.^^"),
  ("story_jute3","You are a Parthian and you are short in stature but agile. A loyal servant of the Parthian King.^^"),
  ("story_kushan","You are an Kushan and you are of an average height. A civilian of the Kushan Empire.^^"),
  ("story_kushan2","You are an Kushan and you are tall and strong. A civilian of the Kushan Empire^^"),
  ("story_kushan3","You are an Kushan and you are short in stature but agile. A civilian of the Kushan Empire^^"),   
  ("story_dahae","You are an Dahaen and you are of an average height. A member of the Dahaen tribe.^^"),
  ("story_dahae2","You are an Dahaen and you are tall and strong. A member of the Dahaen tribe^^"),
  ("story_dahae3","You are an Dahaen and you are short in stature but agile. A member of the Dahaen tribe^^"),   
  ("story_frisian","You are an Berber, you are of an average height. You are an member of a Berber Tribe.^^"),
  ("story_frisian2","You are Berber, you are tall and strong. You are an member of a Berber Tribe.^^"),
  ("story_frisian3","You are Berber, you are short in stature but agile. You are an member of a Berber Tribe..^^"),
  ("story_egyptian","You are an Egyptian and you are of an average height. A civilian of the Roman Empire.^^"),
  ("story_egyptian2","You are an Egyptian and you are tall and strong. A civilian of the Roman Empire^^"),
  ("story_egyptian3","You are an Egyptian and you are short in stature but agile. A civilian of the Roman Empire^^"),  
  ("story_greek","You are an Greek and you are of an average height. A civilian of the Roman Empire.^^"),
  ("story_greek2","You are an Greek and you are tall and strong. A civilian of the Roman Empire^^"),
  ("story_greek3","You are an Greek and you are short in stature but agile. A civilian of the Roman Empire^^"),  
  ("story_vaegir","You are a German and you are of an average height. A member of a German Tribe.^^"),
  ("story_vaegir2","You are a German and you are tall and strong. A member of a German Tribe.^^"),
  ("story_vaegir3","You are a German and you are short in stature but agile. A member of a German Tribe.^^"),
  ("story_khergit","You are a German and you are of an average height. A member of Celtic people inhabiting ancient Britain.^^"),
  ...
  ("story_nord","You are Slavic and you are of an average height. A member of the Slavic people inhabiting Steppes.^^"),
  ("story_nord2","You are Slavic and you are tall and strong. A member of the Slavic people inhabiting Steppes.^^"),
  ("story_nord3","You are Slavic and you are short in stature but agile. A member of the Slavic people inhabiting Steppes.^^"),
  ("story_armenian","You are Armenian and you are of an average height. A civilian of the Armenian Kingdom.^^"),
  ("story_armenian2","You are Armenian and you are tall and strong. A civilian of the Armenian Kingdom.^^"),
  ("story_armenian3","You are Armenian and you are short in stature but agile. A civilian of the Armenian Kingdom.^^"), 
  ("story_rhodok","You are a Sarmatian of an average height, A member of the Sarmatian tribe.^^"),
  ("story_rhodok2","You are a tall and strong Sarmatian, A member of the Sarmatian tribe.^^"),
  ("story_rhodok3","You are a Sarmatian, A member of the Sarmatian tribe.^^"),
  ("story_parent_noble","Your father was of lower Senator class and possessed five hides of land. He owed military service to the Emperor and went to war with his legions whenever the Empire was treated.^^"),
 ...
 He was eventually killed by the hand of a lesser lord's retinue who was sent to sweep the forests and get rid of the pest.^^"),
  ("story_parent_nomad","Your father was an free peasant who was tied to his work on a farm'. He lived a very simple but tough life.^^"),
  ("story_parent_thief","Your father was a slave to a local senator and had to work hard in order not to be beaten.^^"),
  ("story_parent_priest","Your father was a free man who lived a relative peaceful live.\
 He owned a horse and occasionally served as a foot soldier where he had to rely on his shield and sword.^^"),
#child
 ...
 leadership, tactics and all other things that you would need in order to survive on the battlefield. Looting after the successful raid was of course always the best part of the whole deal.^^"),
  ("story_childhood_acolyte","{reg11?In your early ages you were sent to live in the nearest temple to be trained as a priesteres. As such you were one of the few girls who learned how to read and write.\
 Life in the temple was strict and there wasn't much time to play with other girls but you spent time in prayer, studied and worked in the fields and workshops.\
 ...
 you were sent to live in the nearest temple to be trained as a monk. As such you were one of the few boys who learned how to read and write.\
 Life in the temple was strict and there wasn't much time to play with other boys but you spent time in prayer, studied and worked in the fields and workshops.\
 You were learning how to copy books by hand and decorated the pages in beautiful colours but much more years would have to pass before you would become a master in this art. You learned all sorts of basic healing and a bit of a rudimentary surgery to.\
...
#job
 ...
 firewood that warmed many freezing homes during winter. All for a few silvers and a bit of an honor loss, of course. When times were tough you foraged for food and got proficient in finding eatable plants in the wilds.^^"),
  ("story_job_preacher"," You have control over Colonia Ulpia Traiana and are loyal to Roman Gallia. \
 Though the distinction felt sudden to you,\
 somewhere along the way you had become a {reg11?woman:man}, and the whole world seemed to change around you.\
 You have had contacts in the passed that have paid off. Various nobles have agreed to give you able Roman men to fight with you! \
 You march out with your troops, into the unknowning....^^"),
  #reason
 ...
 There were others in the world, souls to be washed in the light of Rome. Now you preach wherever you go,\
 seeking to bring salvation and revelation to the masses, be they faithful or Barbarian. They will all know the\
 glory of Rome by the time you're done...^^"),
 ...
 You want everything, and you won't let anyone stop you from having it...^^"),
  #religion
  ("story_christian","Your family is of pure Roman blood and it roots come from Italy and perhaps Rome itself! You honour the Roman gods and it's traditions."),
  ("story_oldgods","Your family is part of one of the many nomadic clans."),
  ("story_pagangods","Your family comes from a local clan. You honour your old gods and it's ways. You hate the Romans and their imperialistic people!"),
  ("story_romanc","Your family comes from an Eastern clan."),
