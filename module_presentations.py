    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (assign, ":cur_troop", "trp_roman_n_legionary"),
      (else_try),
...
#chief creacion pj dunde
   ...
   [(ti_on_presentation_load,
     [(presentation_set_duration, 999999),
      (set_fixed_point_multiplier, 1000),
      # Init Values
      (str_clear, s11),(str_clear, s12),(str_clear, s13),(str_clear, s14),(str_clear, s15),(str_clear, s16),(str_clear, s17),(str_clear, s18),(str_clear, s19),(str_clear, s20),(str_clear, s21),(str_clear, s22),(str_clear, s23),(str_clear, s24),
      ...
      (create_slider_overlay, "$g_presentation_obj_22",  100, 3900), # Nationality   : Swadian, Vaegir, Kherghit, Nord, Rhodhok
...
("ccp_character_creation", 0, mesh_game_log_window, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
		
		(call_script, "script_gpu_create_mesh", "mesh_load_window", 0, 0, 1000, 1325),
...
#### JART ####
		...
		[
			(ti_on_presentation_load,
				[
					...
					(assign, ":num_options", 17),
					(assign, ":y_increment", 50),
					(store_mul, ":texts_y", ":y_increment", ":num_options"),
					...
					(assign, "$adv_diplomacy_inputs_horse_speed", reg0),
					...
					(overlay_set_val, "$adv_diplomacy_inputs_horse_speed", ":actual_input_value"),
					...
					(overlay_set_position, reg0, pos2),  
					(val_sub, ":inputs_y", ":y_increment"),	
					(assign, "$adv_diplomacy_inputs_battle_continuation", reg0),	
					...
					(overlay_set_val, "$adv_diplomacy_inputs_battle_continuation", ":actual_input_value"),
					
						## TERRAIN ADVANTAGE
					(create_text_overlay, reg0, "@Terrain advantage:", tf_vertical_align_center),
					(position_set_y, pos1, ":texts_y"),
					(overlay_set_position, reg0, pos1),
					(val_sub, ":texts_y", ":y_increment"),
					...
					(overlay_set_position, reg0, pos2),  
					(val_sub, ":inputs_y", ":y_increment"),
					(assign, "$adv_diplomacy_inputs_terrain_advantage", reg0),
					...
					(overlay_set_val, "$adv_diplomacy_inputs_terrain_advantage", ":actual_input_value"),
					...
					(overlay_set_position, reg0, pos2),	
					(val_sub, ":inputs_y", ":y_increment"),	
					(assign, "$adv_diplomacy_inputs_lords_returning", reg0),	
					...
					(overlay_set_val, "$adv_diplomacy_inputs_lords_returning", ":actual_input_value"),
					...
					(val_add, ":inputs_y", 8),
					(val_sub, ":inputs_y", ":y_increment"),
					(assign, "$adv_diplomacy_inputs_ai_changes", reg0),
					...
					(overlay_set_val, "$adv_diplomacy_inputs_ai_changes", ":actual_input_value"),								
					...
					(val_add, ":inputs_y", 8),
					(val_sub, ":inputs_y", ":y_increment"),
					(assign, "$adv_diplomacy_inputs_economics_behavioral", reg0),
					...
					(val_add, ":inputs_y", 8),
					(val_sub, ":inputs_y", ":y_increment"),		
					(assign, "$adv_diplomacy_inputs_prejudice_level", reg0),
					...
					(overlay_set_val, "$adv_diplomacy_inputs_ai_changes", ":actual_input_value"),
						...
						## CHEAT MENU
					(create_text_overlay, reg0, "@Cheat menu:", tf_vertical_align_center),
					(position_set_y, pos1, ":texts_y"),
					(overlay_set_position, reg0, pos1),
					(val_sub, ":texts_y", ":y_increment"),
					...
					(overlay_set_position, reg0, pos2),	
					(val_sub, ":inputs_y", ":y_increment"),		
					(assign, "$adv_diplomacy_inputs_cheat_menu", reg0),
		
					(overlay_set_val, "$adv_diplomacy_inputs_cheat_menu", "$cheat_mode"),
										
					(set_container_overlay, -1),
										
					## MOUSE-OVER TIPS	
					(create_text_overlay, reg0, "@DIPLOMACY^Options", tf_center_justify|tf_with_outline),
					(overlay_set_color, reg0, 0xFFFFFFFF),
					(position_set_x, pos1, 800),
					(position_set_y, pos1, 600),
					(overlay_set_position, reg0, pos1),
					...
					(position_set_y, pos1, 150),
					(overlay_set_area_size, reg0, pos1),
					(assign, "$adv_diplomacy_texts_mouse_over", reg0),
					...
					(overlay_set_position, reg0, pos1),
					(assign, "$adv_diplomacy_button_reset", reg0),
					...
					(position_set_x, pos1, 900),  
					(create_game_button_overlay, reg0, "@Save and exit", tf_center_justify),
					(overlay_set_position, reg0, pos1),
					(assign, "$adv_diplomacy_button_ok", reg0),
			...
			(ti_on_presentation_event_state_change,
				[
					...
					(try_begin),
						(eq, ":object", "$adv_diplomacy_button_reset"),
					...
					(try_begin),
						(eq, ":object", "$adv_diplomacy_button_ok"),
					...
					## HORSE SPEED
					(try_begin),
						(eq, ":object", "$adv_diplomacy_inputs_horse_speed"),			
						(try_begin),
							(eq, ":value", 0),
					...
					## BATTLE CONTINUATION
					(try_begin),
						(eq, ":object", "$adv_diplomacy_inputs_battle_continuation"),			
						(try_begin),
							(eq, ":value", 0),
					...
					## TERRAIN ADVANTAGE
					(try_begin),
						(eq, ":object", "$adv_diplomacy_inputs_terrain_advantage"),			
						(try_begin),
							(eq, ":value", 0),
					...
					## LORDS RETURNING FROM EXILE
					(try_begin),
						(eq, ":object", "$adv_diplomacy_inputs_lords_returning"),			
						(try_begin),
							(eq, ":value", 0),
					...
					## CHEATS MENU
					(try_begin),
						(eq, ":object", "$adv_diplomacy_inputs_cheat_menu"),	
						(assign, "$adv_diplomacy_var_cheat_mode", ":value"), 
					(try_end),			
				]
			 ),
			(ti_on_presentation_mouse_enter_leave, #Mouse-Over Pref-Tips
				[
					...
					##IF THE EVENT IS "LEAVE", WE MAINTAIN THE TEXT THAT IS SHOWED
					(try_begin),
						(eq, ":enter_leave", 1),
					(try_end),
					...
					(try_begin),
						...
						(try_begin),
							...
							(eq, 				":object", 	"$adv_diplomacy_inputs_horse_speed"),	
							(overlay_set_text, "$adv_diplomacy_texts_mouse_over", "@This option makes every horse in battle lose movement speed directly based on their lost Health Points."),       
							(assign, ":presented", 1),
						(try_end),
						...
						(try_begin),
							...
							(eq, 				":object", 	"$adv_diplomacy_inputs_battle_continuation"),	
							(overlay_set_text, "$adv_diplomacy_texts_mouse_over", "@This option let your troops continue fighting even if you fall in battle."),       
							(assign, ":presented", 1),
						(try_end),
						...
						(try_begin),
							...
							(eq, 				":object", 	"$adv_diplomacy_inputs_terrain_advantage"),	
							(overlay_set_text, "$adv_diplomacy_texts_mouse_over", "@This option gives advantage in autocalculated battles to those units who are better in the current terrain.^Horsemen are bad in forest terrain, while archers are better."),       
							(assign, ":presented", 1),
						(try_end),
						...
						(try_begin),
							...
							(eq, 				":object", 	"$adv_diplomacy_inputs_lords_returning"),	
							(overlay_set_text, "$adv_diplomacy_texts_mouse_over", "@This option lets exiled lords return in order to serve a new liege."),       
							(assign, ":presented", 1),
						(try_end),
						
						(try_begin),
							(this_or_next|eq, 	":object", 	"$adv_diplomacy_texts_ai_changes"),
							(eq, 				":object", 	"$adv_diplomacy_inputs_ai_changes"),	
							(overlay_set_text, "$adv_diplomacy_texts_mouse_over", "@This option lets you decide the AI strenght level. The higher this level is, the higher the AI. High level is experimental and may brings some bugs to your game."),       
							(assign, ":presented", 1),
						(try_end),
						
						(try_begin),
							(this_or_next|eq, 	":object", 	"$adv_diplomacy_texts_economics_behavioral"),
							(eq, 				":object", 	"$adv_diplomacy_inputs_economics_behavioral"),	
							(overlay_set_text, "$adv_diplomacy_texts_mouse_over", "@This option changes the economical and behavior values so they re more realistic. High level is experimental and may brings some bugs to your game."),       
							(assign, ":presented", 1),
						(try_end),
						
						(try_begin),
							(this_or_next|eq, 	":object", 	"$adv_diplomacy_texts_prejudice_level"),
							(eq, 				":object", 	"$adv_diplomacy_inputs_prejudice_level"),	
							(overlay_set_text, "$adv_diplomacy_texts_mouse_over", "@This option lets you decide the level of sexism in the game."),       
							(assign, ":presented", 1),
						(try_end),
						...
						(try_begin),
							...
							(eq, 				":object", 	"$adv_diplomacy_inputs_cheat_menu"),	
							(overlay_set_text, "$adv_diplomacy_texts_mouse_over", "@This option enables the cheat menu in campment."),       
							(assign, ":presented", 1),
						(try_end),
						...
						(try_begin),
							(eq, ":presented", 0),
							(overlay_set_text, "$adv_diplomacy_texts_mouse_over", "@Mouse-over options for further information."),       
						(try_end),
					(try_end),	  
				]
			),
 ...
 ("world_map", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 2000),
        
      ## initialization part begin
        # presentation obj: begin from top left corner
        (assign, ":init_pos_x", 50), # init x
        (assign, ":init_pos_y", 1300), # init y
        
        # world map, X: -180 t0 180  Y: -145 t0 145 
        (assign, ":min_map_x", -400*1500),
        (assign, ":max_map_x", 250*1500),
        (assign, ":min_map_y", -175*1500),
        (assign, ":max_map_y", 300*1500),
        ...
        (assign, ":party_move_length", 2*1500),
