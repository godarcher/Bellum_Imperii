...
#    ]),
  ...
  [
    (set_spawn_radius, 1),
    (store_add, ":p_town_22_plus_one", "p_town_22_1", 1),
    (store_random_in_range, ":selected_town", "p_town_1_1", ":p_town_22_plus_one"),
     ...
     (try_for_range, ":companion", companions_begin, companions_end),
       ...
       (try_for_range, ":i_slot", 0, ":inv_cap"),
		 ...
		 (ge, ":item_id", 0),
	 	 ...
	 	 (this_or_next|eq, ":item_id", "itm_h_tribune_yellow_b"),
		 (eq, ":item_id", "itm_h_tribune_yellow_b"),
...
#  CHECKS IF PLAYER WON THE REVOLT
    ...
    [
        ...
        (try_begin),
            ...
            (tutorial_box, "@The released slaves were not be trusted and they are preparing to attack you!", "@Warning!"),
            (start_encounter, "p_temp_party_2"),
            (change_screen_map),
        (else_try),
            (is_between, ":prisoner_state", 5, 10),
            (tutorial_box, "@The released slaves scattered as soon as the battle finished. You will not be seeing them again.", "@Notice!"),
            (party_clear, "p_temp_party_2"),
        (else_try),
            (tutorial_box, "@The released slaves have remained loyal and will join your party", "@Notice!"),
