...
map_icons = [
  ...
  ("rom_town3",mcn_no_shadow,"rom_town3", 0.35,0),
  ("rom_town2",mcn_no_shadow,"rom_town2", 0.35,0),
  ("rom_town1",mcn_no_shadow,"rom_town1", 0.35,0),    
  ("rome_village",mcn_no_shadow,"rome_village", 0.35,0),
  ("roman_legion_camp",mcn_no_shadow,"roman_legion_camp", 0.35,0),     
  ("roman_fort",mcn_no_shadow,"roman_fort", 0.35,0),     
  ("rome_mesh",mcn_no_shadow,"rome_mesh", 0.35,0),     
   
  ("town_icon2",mcn_no_shadow,"town_icon2", 0.35,0),
  ("wall_town_icon",mcn_no_shadow,"wall_town_icon", 0.35,0),    
  ("wall_town_harbour_icon",mcn_no_shadow,"wall_town_harbour_icon", 0.35,0),    
  ("map_tradeport",mcn_no_shadow,"map_tradeport", 0.35,0),    
  ("map_vikingcastle",mcn_no_shadow,"map_vikingcastle", 0.35,0),   
  ("hillfort_icon",mcn_no_shadow,"hillfort_icon", 0.35,0),    
 
   ("icon_arab_village_1",mcn_no_shadow,"icon_arab_village_1", 0.35,0),     
   ("icon_arab_village_2",mcn_no_shadow,"icon_arab_village_2", 0.35,0),     
   ("icon_arab_village_3",mcn_no_shadow,"icon_arab_village_3", 0.35,0),     
   ("icon_arab_village_camp",mcn_no_shadow,"icon_arab_village_camp", 0.35,0),     
   ("icon_camp_big",mcn_no_shadow,"icon_camp_big", 0.35,0),     

   ("iranian_village2",mcn_no_shadow,"iranian_village2", 0.35,0),     
   ("iranian_village1",mcn_no_shadow,"iranian_village1", 0.35,0),     
   ("iranian_castle_mesh",mcn_no_shadow,"iranian_castle_mesh", 0.35,0),     
   ("iranian_town_mesh",mcn_no_shadow,"iranian_town_mesh", 0.35,0),     
