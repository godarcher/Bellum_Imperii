...
meshes = [
  ...
  ("pic_rome", 0, "pic_rome", 0, 0, 0, 0, 0, 0, 1, 1, 1),  
...
#  ("banner_f21", 0, "banner_f21", 0, 0, 0, -90, 0, 180, 1, 1, 1),
  ...
  ("banner_k21", 0, "banner_k21", 0, 0, 0, -90, 0, 0, 1, 1, 1), #chief modifica
  ...
  ("banner_kingdom_3a", 0, "banner_kingdom_3a", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  #chief acaba
...
("background_general", 0, "background_general", 0, 0, 0, 0, 0, 0, 1, 1, 1),
...
## CC
  ...
  ("note_window_bottom", 0, "note_window_bottom", 0, 0, 0, 0, 0, 0, 1, 1, 1),
...
## CC
# Floris - New Background Screens
  ("report_screen", 0, "report_screen", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("background_birds", 0, "background_birds", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("background_budget", 0, "background_budget", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("background_empty", 0, "background_empty", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("background_item", 0, "background_item", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("background_recruit", 0, "background_recruit", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("background_retirement", 0, "background_retirement", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("background_tree", 0, "background_tree", 0, 0, 0, 0, 0, 0, 1, 1, 1),
# Floris - End
