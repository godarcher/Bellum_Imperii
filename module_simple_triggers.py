  ...
  (0,
   [
      (try_begin),
        ...
        (party_set_slot, "p_town_5_1", slot_center_siege_with_belfry, 0),
 ...
 # reserved for future use. For backward compatibility, we need to use these triggers instead of creating new ones.
  ...
  (1,
   [
     ...
     (store_add, ":fac_kingdom_31_plus_one", "fac_kingdom_31", 1),

     (try_for_range, ":faction_1", "fac_kingdom_1", ":fac_kingdom_31_plus_one"),
       (try_for_range, ":faction_2", "fac_kingdom_1", ":fac_kingdom_31_plus_one"),
  ...
  (24,
   ...
   (troop_set_slot, "trp_npc11", slot_troop_home, "p_town_7_1"),
   (troop_set_slot, "trp_npc8", slot_troop_home, "p_village_30_1"),
   
   (troop_set_slot, "trp_npc15", slot_troop_town_with_contacts, "p_town_18_1"), #durquba
   
   #this to correct linen production at villages of durquba 
   (party_set_slot, "p_village_5_1", slot_center_linen_looms, 0), #mazigh
   (party_set_slot, "p_village_6_1", slot_center_linen_looms, 0), #sekhtem
   (party_set_slot, "p_village_7_1", slot_center_linen_looms, 0), #qalyut
   (party_set_slot, "p_village_8_1", slot_center_linen_looms, 0), #tilimsal
   (party_set_slot, "p_village_9_1", slot_center_linen_looms, 0), #shibal zumr
   (party_set_slot, "p_village_10_1", slot_center_linen_looms, 0), #tamnuh
   (party_set_slot, "p_village_11_1", slot_center_linen_looms, 0), #habba

   (party_set_slot, "p_village_12_1", slot_center_fishing_fleet, 0), #Tebandra
   (party_set_slot, "p_village_13_1", slot_center_fishing_fleet, 15), #Kulum
